...
Imagine que você é um super fã de animes e quer saber tudo sobre seu personagem favorito. Essa aplicação é a sua nova melhor amiga! Ela te ajuda a encontrar todas as informações que você precisa de forma rápida e fácil.
...
Resultados na tela: Se a aplicação encontrar algo, ela mostra pra você um card com o nome do personagem, uma breve descrição e um link para saber mais. Se não encontrar nada, ela te avisa que não teve sorte dessa vez.
Tecnologias usadas:
